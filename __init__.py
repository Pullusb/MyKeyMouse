...
def register_keymaps():
    ...
    shortcuts_items.append(["Grease Pencil Stroke Edit Mode", "EMPTY", "gpencil.snap_cursor_to_selected", key_prev, False, True, False])
    shortcuts_items.append(["Grease Pencil Stroke Edit Mode", "EMPTY", "gpencil.snap_to_cursor", key_next, False, True, False])
